<template>
  <div class="Quality-features bg-light mt-5 py-5">
    <div class="container-fluid">
      <div class="row">
        <div
          class="col-sm-6 col-md-3 rounded text-center bg-white p-1 pt-5"
          style="height: 280px"
          v-for="card in cards"
          :key="card.title"
        >
          <span class="pb-3 d-block" v-html="card.svg"></span>
          <h3>{{ card.title }}</h3>
          <p>{{ card.desc }}</p>
        </div>
      </div>
